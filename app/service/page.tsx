            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                <Input 
                  ...
                  className="flex-grow"
                />
                <Button type="button" onClick={sendVerificationCode} disabled={isVerified} className="w-full sm:w-auto">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                  <Input
                    ...
                    className="flex-grow"
                  />
                  <Button type="button" onClick={verifyCode} disabled={isVerifying} className="w-full sm:w-auto">
